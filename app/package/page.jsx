...
const tourData = {
  ...
  inclusions: [
    "4 nights stay in Dubai",
    "Daily breakfast at the hotel",
    "Dubai city tour with Burj Khalifa 124th floor tickets",
    "Desert Safari with BBQ dinner (Sharing basis)",
    "Dhow Cruise Dinner Marina (Sharing basis)",
    "Abu Dhabi city tour with Ferrari World (Bronze Pass)",
    "Dubai Frame tickets",
    "All transfers on Sharing basis",
    "Airport transfers from Dubai International Airport to Hotel/Hotel to Airport",
    "Visa Assistance",
  ],
  exclusions: [
                  ...
                  <AccordionItem key={index} value={`day-${day.day}`}>
                    <AccordionTrigger className="hover:no-underline">
                      <div className="flex items-center">
                        <span className="bg-primary text-white py-1 px-2 rounded-full text-sm font-semibold mr-2">Day {day.day}</span>
